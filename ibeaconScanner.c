...
//compare current time to reserved time
...
int main(int argc, char **argv){
    ...
    if(isCorrectCar = ibeaconScanner(uuidFromServer)){
        printf("correct car...!!\n");
        
        if(isCorrectTime = compareTime(getReservedTimeFromServer())) 
            printf("correct Time...!\n");
        else printf("incorrect Time...\n");
    }
    else printf("not Found Right Car...\n");
}
